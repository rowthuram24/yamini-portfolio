          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                ...
                or just want to connect. I'm always excited to hear from fellow developers and potential collaborators.
              </p>
            </div>
              ...
              <div className="flex space-x-4">
                {socialLinks.map((social) => (
                  <a
                    ...
                    className={`p-3 bg-white dark:bg-gray-700 rounded-lg shadow-md hover:shadow-lg transform hover:scale-110 transition-all duration-300 text-gray-600 dark:text-gray-300 ${social.color}`}
                  >
